...
summary: "网易雷火全栈一面凉经 22 问：前半程深挖 UniApp 多端适配与 H5、小程序样式维护、小程序登录链路与分包加载、白屏优化，接着是搜索输入与并发请求、长列表渲染优化，后半程考 AI 知识库的请求分流、置信度策略、RAG 缓存与调用次数控制，以及真实项目里如何用 AI 做开发与评审。"
---
