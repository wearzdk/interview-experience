...
summary: "辉芒微电子应用工程师面经，按模块整理。除自我介绍与职业规划外，重点考察 OTA 升级流程、毕设与项目细节，以及 MCU 基础：STM32F103 的 72MHz 主频怎么产生、取指插入多少等待周期、软件 IO 翻转频率上限、低功耗设计，还有 IIC/SPI/UART 的软硬件实现选择与完整时序细节。"
---
...
2. 目前在找哪类工作？职业规划是什么？
3. 你的长处和短处是什么？请举具体实例。
4. 项目中的 OTA 升级流程是怎样的？（原帖注明问得很细）
5. 毕设做的是什么？
6. 主要接触过哪些 MCU？
7. STM32F103 跑在什么主频上？72M 主频是怎么产生的？
8. 72M 主频下取指令要插入多少个等待周期？
9. 软件 IO 的翻转频率可以达到多少？
10. MCU 低功耗怎么设计？
11. IIC、SPI、UART 是用硬件实现还是软件模拟？
12. 串口从机用 GPIO 翻转去模拟串口接收数据，应该怎么操作？（主要考察串口时序）
13. IIC 时序：几根信号线？开始、结束、应答信号怎么定义？上升沿还是下降沿采样？SDA 的 IO 类型是什么？为什么这样设计？
14. SPI：几根信号线？时序是怎样的？怎么通信？
